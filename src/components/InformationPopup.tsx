import "../style/InformationPopup.scss";
            ...
            <div className={"content"}>
                <div className={"content-text"}>
                    ...
                    <p>
                        ...
                        Liegenschaftskatasterinformationssystem (ALKIS®). Es war nötig zwei Datensätze zu verwenden, da
                        in Bayern seit 2014 ALB durch ALKIS® abgelöst wurde.
                        <br />
                        <br />
                        <a
                            href={
                    ...
                    <p>
                        Der Flächenverbrauch beschäftigt sich mit der Zunahme von Siedlungs- und Verkehrflächen (SuV),
                        dabei zählen Agrar- und Forstflächen nicht mit rein. Dies ist abzugrenzen von versiegelter
                        Fläche, denn der Flächenverbrauch beinhaltet auch nicht versiegelte Flächen wie Gärten,
                        Friedhöfe oder Stellplätze.
                    </p>
                    <h1>Berechnung Flächenverbrauch</h1>
                    <p>
                        Der Flächenverbrauch ergibt sich aus &quot;Fläche für Siedlung (10000)&quot; und &quot;Fläche
                        für Verkehr (20000)&quot;, dabei wird bei der Siedlungsfläche &quot;Bergbaubetrieb (14000)&quot;
                        und &quot;Tagebau, Grube, Steinbruch (15000)&quot; abgezogen. Tagebau und co. gilt als nicht
                        verbraucht Fläche, da diese in einigen Jahren als See, Wiese oder Wald wieder verwendet wird.
                        Welche Kategorien genau zum Flächenverbrauch zählen sieht man im Diagramm am Ende dieser Seite.
                        <br />
                        <br />
                    ...
                    <p>
                        ...
                        einen Einfluss auf den berechneten Flächenverbrauch. Zum Beispiel zählten Truppenübungsplätze
                        unter ALB zu Grünflächen. In ALKIS® steht es jedem Bundesland frei Truppenübungsplätze als
                        Siedlungsfläche oder als Grünfläche zu kategorisieren. Dadurch kann es passieren, dass der
                        Flächenverbrauch einen Sprung nach unten oder oben macht. Eigene Kategorien Eine Grenze des
                        Projekts war es nur OpenData zu verwenden, dabei haben wir nicht alle Kategorien, sondern
                        größtenteils nur zusammengefasste Kategorien, erhalten.
                    </p>
                    ...
                    <p>
                        ...
                        Flächen vermischt wurden. Die genaue Aufschlüsselung sieht man im folgenden Diagramm. Von links
                        nach rechts stellen die Spalten die Gesamtfläche, die (un)verbrauchte Fläche, die eigenen
                        Bereiche und die ALB- / ALKIS®-Kategorien dar.
                    </p>
                </div>
